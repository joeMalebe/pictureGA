...
public class Main {
	...
	public static void main(String[] args) {
		...
		while(true){
			...
			System.out.println("generation : "+ gen + "\t Total Fitness : " + pop.getTotalFitness() + "\t Fittest individual : " + pop.getFittest().getFitness() + "\t Mutation Rate : " + Crossover.mutationRate);
